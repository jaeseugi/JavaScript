...
// Array
// 1. Declaration
startLog('Declaration');
const arr1 = new Array();
const arr2 = [1,2];

// 2. Index position
startLog('Index position');
const fruits = ['사과','바나나'];
console.log(fruits);
...
// print all fruits
startLog('Looping over an array');
// a. for
...
startLog('Additon, deletion, copy')
// push : add an item to the end
fruits.push('딸기','복숭아');
console.log(`딸기,복숭아 추가 : ${fruits}`);

// pop : remove an item from the end
fruits.pop();
fruits.pop();
console.log(`pop 2번 호출 : ${fruits}`);

// unshift : add an item to benigging
fruits.unshift('딸기','오렌지');
console.log(`unshift 딸기,오렌지 : ${fruits}`);

// shift : remove an tiem from the benigging
fruits.shift();
fruits.shift();
console.log(`shift 2번호출 : ${fruits}`);
...
console.log(`딸기,복숭아,오렌지 추가 :  ${fruits}`);
fruits.splice(1,1);
console.log(`fruits.splice(1,1) : ${fruits}`);
fruits.splice(1,1,'사과','수박'); // (1,0,'사과','수박') 지우지않고 추가
console.log(`fruits.splice(1,1,'사과','수박'); ${fruits}`);

// combine two arrays
const fruit2 = ['배','모과'];
const newFruits = fruits.concat(fruit2);
console.log(`fruits.concat(fruit2) : ${newFruits}`);
